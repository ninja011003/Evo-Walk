...
class InputField:
    def __init__(self, x, y, width, height, key, value, on_change=None, editable=True):
    ...
    def draw(self, surface, offset_x=0, offset_y=0):
        rect = pygame.Rect(self.rect.x + offset_x, self.rect.y + offset_y, 
...
class DebugPanel:
    ...
    def _rebuild_fields(self):
        ...
        for key, value in debug_info.items():
            ...
            editable = key not in self.READ_ONLY_KEYS and hasattr(self.selected_object, 'set_property')
    ...
    def _on_value_change(self, key, new_value):
        if self.selected_object and hasattr(self.selected_object, 'set_property'):
    ...
    def draw(self, surface):
        ...
        if self.selected_object is None:
            ...
            type_surface = font_debug_title.render(obj_type, True, (255, 255, 255))
            ...
            help_text = font_debug_label.render("Enter to apply | Esc to cancel", True, (70, 70, 90))
...
class SimulationUI:
                ...
                if self.mode == "bob":
                    ...
                    if clicked_bob:
                        if self.connecting_bob is None:
                            ...
                            new_rod = self.engine.create_rod(self.connecting_bob, clicked_bob)
                            if new_rod:
    ...
    def draw(self, surface):
        ...
        help_text = font_small.render("SPACE: Start/Stop | D: Debug | DEL: Delete | ESC: Cancel | Right-Click: Inspect", True, (80, 80, 100))
